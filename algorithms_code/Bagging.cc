...
const string TRAINING_FILE = "F:\\track2\\training_interactionfeatures_40M2.txt";
const string VALIDATION_FILE = "F:\\track2\\validation_interactionfeatures2.txt";
const string SMALLVALIDATION_FILE = "F:\\track2\\smallvalidation_interactionfeatures2.txt";
const string TESTING_FILE = "F:\\track2\\testing_interactionfeatures2.txt";
const string SUBMISSION_FILE = "F:\\track2\\submission_interactionfeatures2.txt";
const string OUTPUT_SUBMISSION_FILE = "F:\\track2\\output_submission_bagging.txt";
const string OUTPUT_WMAE_FILE = "F:\\track2\\output_wmae_bagging.txt";
const string ADTITLE_TOKENS_FILE = "C:\\Users\\Arvind\\Desktop\\data\\titleid_tokensid2.txt";
const string ADDESCRIPTION_TOKENS_FILE = "C:\\Users\\Arvind\\Desktop\\data\\descriptionid_tokensid2.txt";
const string KEYWORD_TOKENS_FILE = "C:\\Users\\Arvind\\Desktop\\data\\purchasedkeywordid_tokensid2.txt";
const string DISPLAYURL_PROPERTIES_FILE = "C:\\Users\\Arvind\\Desktop\\data\\displayurl_clicks_impressions_uniqueusers2.txt";
const string ADVERTISER_PROPERTIES_FILE = "C:\\Users\\Arvind\\Desktop\\data\\advertiser_properties2.txt";
const string USER_FEATURES_FILE = "C:\\Users\\Arvind\\Desktop\\data\\userid_profile2.txt";
const string TOKENCOUNTS_UNIQUE_QUERIES_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_queryid_tokensid2.txt";
const string TOKENCOUNTS_TRAINING_QUERIES_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_training_querytokensid2.txt";
const string TOKENCOUNTS_TRAINING_KEYWORDS_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_training_keywordtokensid2.txt";
const string TOKENCOUNTS_ADTITLE_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_titleid_tokensid2.txt";
const string TOKENCOUNTS_ADDESCRIPTION_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_descriptionid_tokensid2.txt";
const string TOKENCOUNTS_KEYWORD_FILE = "C:\\Users\\Arvind\\Desktop\\data\\analysis_purchasedkeywordid_tokensid2.txt";
...
int randomsamplecounts[MAX_TRAINING_LINES];
int total_passes_over_training_file = 0;
...
void DoRandomSamplingWithReplacement()
{
  memset(randomsamplecounts, 0, sizeof(randomsamplecounts));
  int index = 0;
  REP(i, MAX_TRAINING_LINES)
  {
    index = rand() % MAX_TRAINING_LINES;
    randomsamplecounts[index]++;
  }
}

void UpdatePredictedValues(string file, int phase, int globaliteration)
{
  ifstream fin(file.cs);
  ...
  while(!fin.eof())
  {
    ...
    {
      prevtrainpredictions[iteration] += yhat;
      wmae += impressions * abs(prevtrainpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
      rmse += impressions * (prevtrainpredictions[iteration] / total_passes_over_training_file + meanadctr - target) * (prevtrainpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
    }
    else if(phase == PHASE_VALIDATION)
    {
      prevvalidpredictions[iteration] += yhat;
      wmae += impressions * abs(prevvalidpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
      rmse += impressions * (prevvalidpredictions[iteration] / total_passes_over_training_file + meanadctr - target) * (prevvalidpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
    }
    else if(phase == PHASE_TESTING)
    {
      prevtestingpredictions[iteration] += yhat;
      wmae += impressions * abs(prevtestingpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
      rmse += impressions * (prevtestingpredictions[iteration] / total_passes_over_training_file + meanadctr - target) * (prevtestingpredictions[iteration] / total_passes_over_training_file + meanadctr - target);
    }
    else if(phase == PHASE_SUBMISSION)
    {
      prevsubmissionpredictions[iteration] += yhat;
      foutsubmission << (prevsubmissionpredictions[iteration] / total_passes_over_training_file + meanadctr) << endl;
    }
    ...
    if(iteration < 5)
    {
      ...
      {
        dbg(iteration); dbg(meanadctr); dbg(impressions); dbg(target); dbg(yhat); dbge(total_passes_over_training_file);
    ...
    if(iteration % 1000000 == 0)
      cout<<"Time taken to output "<< iteration <<" lines is: "<<(float)(clock()-start)/(float)CLOCKS_PER_SEC<<" seconds"<<endl;
  }
...
void DoBaggingOverTrainingFile()
{
  int iteration = -1;
  ...
  {  
    ...
    //Do Random Sampling with Replacement
    DoRandomSamplingWithReplacement();
    ...
    while(!fin.eof())
    {
      ...
      if(randomsamplecounts[iteration] == 0)
      {
        if(iteration % 1000000 == 0)
          cout<<"Time taken to output "<< iteration <<" lines is: "<<(float)(clock()-start)/(float)CLOCKS_PER_SEC<<" seconds"<<endl;
      ...
      //Do as many updates as there are counts of this sample in the random sampled corpus
      REP(i, randomsamplecounts[iteration])
      {
    ...
    fin.close();
    total_passes_over_training_file += 1;
      
    UpdatePredictedValues(TRAINING_FILE, PHASE_TRAINING, iteration);
    UpdatePredictedValues(VALIDATION_FILE, PHASE_VALIDATION, iteration);
    UpdatePredictedValues(TESTING_FILE, PHASE_TESTING, iteration);
    UpdatePredictedValues(SUBMISSION_FILE, PHASE_SUBMISSION, iteration);
