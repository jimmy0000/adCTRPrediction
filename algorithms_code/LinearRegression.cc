...
const string TRAINING_FILE = "F:\\track2\\training_interactionfeatures2.txt";
...
const string OUTPUT_TRAINING_FILE = "F:\\track2\\output_training_linearregression.txt";
const string OUTPUT_VALIDATION_FILE = "F:\\track2\\output_validation_linearregression.txt";
const string OUTPUT_TESTING_FILE = "F:\\track2\\output_testing_linearregression.txt";
const string OUTPUT_SUBMISSION_FILE = "F:\\track2\\output_submission_linearregression.txt";
const string OUTPUT_WMAE_FILE = "F:\\track2\\output_wmae_linear_regression.txt";
...
int modeltype = MODELTYPE_LINEAR_REGRESSION;
